...
// Xử lý nút thêm phim vào danh sách phim yêu thích
//document.addEventListener("DOMContentLoaded", function () {
//    const favButton = document.getElementById("btn-addFavorite");
//
//    if (favButton) {
//        favButton.addEventListener("click", function (e) {
//            e.preventDefault(); // Quan trọng để tránh hành vi mặc định (nếu có form)
